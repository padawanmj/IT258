...
public class ChooseManager
{
	...
	public static void main(String[] args)
	{
		...
		String chosenManager;
			...
			System.out.println("Enter " + PRIVATE_CODE + " for private, " + CORPORATE_CODE + " for corporate.");
	...
	if(eventType == PRIVATE_CODE)
		...
		chosenManager = CORP_MANAGER;
			...
			System.out.println("You entered " + eventType);	System.out.println("Manager of this event will be " + chosenManager);
	}
}